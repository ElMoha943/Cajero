...
Public Class Form1
    ...
    Private Sub TextBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox1.KeyPress
        If (e.KeyChar = Convert.ToChar(Keys.Enter)) Then
            ...
            If exists = 1 Then
                ...
                lista.Add(New Producto(tempname, tempprice))
            Else
    ...
    Private Sub Imprimir_Click(sender As Object, e As EventArgs) Handles Imprimir.Click
        ...
        Try
            conn.Open()
            comando.ExecuteNonQuery() ' CREA EL TICKET

            sqlquery = "SELECT MAX(id) as id FROM tickets " ' CONSIGE EL ID DEL TICKET
            ...
            While i < lista.Count
                sqlquery = "INSERT INTO tickets_productos (ticket_id, producto, precio) VALUES (" & ID & ", '" & lista.Item(i).nombre & "', " & lista.Item(i).precio & ");" ' INSERTA LOS PRODUCTOS
                comando.CommandText = sqlquery
